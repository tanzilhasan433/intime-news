        ...
        <div>
          ...
          <Card.Container className="p-6">
            ...
            <Card.Container className="my-3">
              ...
              <Card.Description>
              অস্ট্রেলিয়ায় বাংলাদেশের হাইকমিশনার এম আল্লামা সিদ্দীকী বলেছেন, হাজার বছরে সৃষ্টি হওয়া বাঙালি জাতি সত্তাকে বঙ্গবন্ধু শেখ মুজিবুর রহমান তার ঐন্দ্রজালিক ক্ষমতার মাধ্যমে পূর্ণতা দেন। 
              </Card.Description>
            </Card.Container>
